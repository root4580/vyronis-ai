...
export function buildTimeframeVisionPrompt(
  ...
  return [
    ...
    "",
    "Top-Down AOI overlay rules (strict priority):",
    "1. Weekly/Daily directional bias drives all lower-timeframe reads.",
    "2. H4 must confirm HTF direction — mark conflict when it does not.",
    "3. AOI zones ONLY from meaningful supply/demand or post-BOS areas — label valid vs invalid.",
    "4. M15 requires confirmation candle CLOSE before entry — mark missing close as mistake.",
    "5. Flag overextended/chase entries and displacement candles.",
    "6. Penalize countertrend setups vs HTF bias with countertrend + chase_risk annotations.",
    "7. Penalize messy/choppy H1 structure with chase_risk on H1.",
    "",
