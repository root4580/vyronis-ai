...
import { ChapterReviewView } from "@/components/weekly-chapters/chapter-review-view"
...
export function ChapterReviewRoute({ weekStart }: ChapterReviewRouteProps) {
  const router = useRouter()
  const chrome = useDashboardChrome({ loginNextPath: `/chapters/${weekStart}` })
  ...
  return (
    <>
      ...
      >
        <ChapterReviewView weekStart={weekStart} accountId={chrome.activeAccountId} />
      </DashboardChrome>
