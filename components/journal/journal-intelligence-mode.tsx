...
export function JournalIntelligenceMode({
  ...
  return (
    <div className="space-y-4">
          ...
          {patterns.patterns.slice(0, 5).map((p) => (
            <div
              ...
              className={cn(
                ...
                p.severity === "warning" && "border-amber-500/25 bg-amber-500/[0.06] text-amber-100/90",
      ...
      <div className="flex items-start gap-2 rounded-lg border border-amber-500/20 bg-amber-500/[0.05] px-3 py-2 text-[11px] text-amber-100/85">
