...
import { TradeIntelligencePage } from "@/components/journal/trade-intelligence-page"
...
export function TradeIntelligenceRoute({ tradeId }: { tradeId: string }) {
  const router = useRouter()
  const chrome = useDashboardChrome({ loginNextPath: `/journal/trade/${tradeId}` })
