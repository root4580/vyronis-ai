...
function PracticeRoomContent() {
  ...
  const chrome = useDashboardChrome({ loginNextPath: "/practice-room" })
  ...
  return (
    <>
      ...
      >
        <PracticeRoomWorkspace
          accountId={chrome.activeAccountId}
          rulesSnapshot={chrome.tradingRules.snapshot}
        />
      </DashboardChrome>
...
export function PracticeRoomRoute() {
  return (
