-- Strategy Brain: discretionary forex decision system (no automation)
-- Run in Supabase → SQL Editor after prior migrations

-- ── Market bias (HTF alignment) ─────────────────────────────────────────────
...
-- ── Setup evaluations (scoring snapshots) ───────────────────────────────────
